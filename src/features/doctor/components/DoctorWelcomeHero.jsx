    ...
    <section className="patient-hero relative overflow-hidden rounded-3xl">
      ...
      <div className="relative grid grid-cols-1 items-center gap-8 p-6 sm:p-8 lg:grid-cols-12 lg:gap-10 lg:p-10">
        <div className="lg:col-span-7">
          <span className="inline-flex items-center gap-1.5 rounded-full border border-blue-200/60 bg-blue-50 px-3 py-1 text-xs font-bold text-blue-700">
            <Sparkles size={13} />
            لوحة الطبيب · CareLink
          </span>
          ...
          <p className="mt-3 max-w-lg text-sm leading-7 text-slate-600 sm:text-base">
            تابع المواعيد المعلقة، مرضاك، والسجلات الطبية من مكان واحد —
            قرارات أوضح ومتابعة أسهل.
          </p>
          ...
          <div className="mt-8 flex flex-wrap gap-4 border-t border-white/60 pt-6">
            {[
              ...
              <div key={item.label}>
                ...
                <p className="text-sm font-extrabold text-[#101860]">
                  {item.value}
                </p>
              </div>
            ))}
...
export default DoctorWelcomeHero;
