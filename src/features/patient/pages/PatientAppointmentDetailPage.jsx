...
import { APPOINTMENT_TYPE_LABELS } from "../constants/appointmentLabels";
import {
  getDoctorInfo,
  MOCK_APPOINTMENTS,
...
function PatientAppointmentDetailPage() {
  ...
  const doctorInfo = getDoctorInfo(appointment.doctor_name);
            ...
            <div>
              ...
              {doctorInfo && (
                <div className="mt-2 flex flex-wrap items-center gap-3 text-xs font-bold text-slate-500">
                  ...
                  <span>{doctorInfo.experience_years} سنة خبرة</span>
                </div>
              )}
            </div>
          </div>
        ...
        <div className="space-y-4">
          ...
          <div className="patient-card rounded-2xl border border-slate-200/90 bg-white p-6 shadow-sm">
            ...
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <p className="font-bold text-blue-950">{appointment.doctor_name}</p>
                <p className="text-sm text-slate-500">
                  {appointment.doctor_specialty}
                </p>
